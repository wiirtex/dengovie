...
func (_m *MockStorage) CreateUser(ctx context.Context, input types.CreateUserInput) (types.User, error) {
	ret := _m.Called(ctx, input)
	...
	var r0 types.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.CreateUserInput) (types.User, error)); ok {
		return rf(ctx, input)
	}
	if rf, ok := ret.Get(0).(func(context.Context, types.CreateUserInput) types.User); ok {
		r0 = rf(ctx, input)
	} else {
		r0 = ret.Get(0).(types.User)
	}

	if rf, ok := ret.Get(1).(func(context.Context, types.CreateUserInput) error); ok {
		r1 = rf(ctx, input)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockStorage_Expecter) CreateUser(ctx interface{}, input interface{}) *MockStorage_CreateUser_Call {
	return &MockStorage_CreateUser_Call{Call: _e.mock.On("CreateUser", ctx, input)}
}

func (_c *MockStorage_CreateUser_Call) Run(run func(ctx context.Context, input types.CreateUserInput)) *MockStorage_CreateUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.CreateUserInput))
	})
	return _c
}

func (_c *MockStorage_CreateUser_Call) Return(_a0 types.User, _a1 error) *MockStorage_CreateUser_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStorage_CreateUser_Call) RunAndReturn(run func(context.Context, types.CreateUserInput) (types.User, error)) *MockStorage_CreateUser_Call {
	_c.Call.Return(run)
	return _c
}
...
// UpdateUserChatID provides a mock function with given fields: ctx, input
func (_m *MockStorage) UpdateUserChatID(ctx context.Context, input types.UpdateUserChatIDInput) error {
	ret := _m.Called(ctx, input)

	if len(ret) == 0 {
		panic("no return value specified for UpdateUserChatID")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, types.UpdateUserChatIDInput) error); ok {
		r0 = rf(ctx, input)
	} else {
		r0 = ret.Error(0)
	}
...
// MockStorage_UpdateUserChatID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateUserChatID'
type MockStorage_UpdateUserChatID_Call struct {
	*mock.Call
}

// UpdateUserChatID is a helper method to define mock.On call
//   - ctx context.Context
//   - input types.UpdateUserChatIDInput
func (_e *MockStorage_Expecter) UpdateUserChatID(ctx interface{}, input interface{}) *MockStorage_UpdateUserChatID_Call {
	return &MockStorage_UpdateUserChatID_Call{Call: _e.mock.On("UpdateUserChatID", ctx, input)}
}

func (_c *MockStorage_UpdateUserChatID_Call) Run(run func(ctx context.Context, input types.UpdateUserChatIDInput)) *MockStorage_UpdateUserChatID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.UpdateUserChatIDInput))
	})
	return _c
}

func (_c *MockStorage_UpdateUserChatID_Call) Return(_a0 error) *MockStorage_UpdateUserChatID_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockStorage_UpdateUserChatID_Call) RunAndReturn(run func(context.Context, types.UpdateUserChatIDInput) error) *MockStorage_UpdateUserChatID_Call {
	_c.Call.Return(run)
	return _c
}
